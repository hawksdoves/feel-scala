...
class InterpreterLiteralExpressionTest
  ...
  it should "be defined with timezone" in {
    eval(""" time("10:30:00@Europe/Berlin") """) should be(ValTime(
      ZonedTime.of(
        time = LocalTime.parse("10:30:00"),
  ...
  it should "be defined with '@' and no offset" in {
    eval(""" @"10:30:00" """) should be (ValLocalTime(
      LocalTime.parse("10:30:00")
    ))
  }

  it should "be defined with '@' and offset" in {
    eval(""" @"10:30:00+02:00" """) should be(ValTime(
      ZonedTime.of(
        time = LocalTime.parse("10:30:00"),
        offset = ZoneOffset.ofHours(2))
    ))
  ...
  it should "be defined with '@' and timezone" in {
    eval(""" @"10:30:00@Europe/Berlin" """) should be(ValTime(
      ZonedTime.of(
        time = LocalTime.parse("10:30:00"),
        zoneId = ZoneId.of("Europe/Berlin")
      )
  ...
  "A date-time literal" should "be defined without offset" in {
    eval(""" date and time("2021-09-08T10:30:00") """) should be (ValLocalDateTime(
      LocalDateTime.parse("2021-09-08T10:30:00")
    ))
  }

  it should "be defined with offset" in {
    eval(""" date and time("2021-09-08T10:30:00+02:00") """) should be(ValDateTime(
      ZonedDateTime.of(
        LocalDateTime.parse("2021-09-08T10:30:00"),
  ...
  it should "be defined with timezone" in {
    eval(""" date and time("2021-09-08T10:30:00@Europe/Berlin") """) should be (ValDateTime(
      ZonedDateTime.of(
        LocalDateTime.parse("2021-09-08T10:30:00"),
  ...
  it should "be defined with '@' and no offset" in {
    eval(""" @"2021-09-08T10:30:00" """) should be (ValLocalDateTime(
      LocalDateTime.parse("2021-09-08T10:30:00")
    ))
  }

  it should "be defined with '@' and offset" in {
    eval(""" @"2021-09-08T10:30:00+02:00" """) should be (ValDateTime(
      ZonedDateTime.of(
        LocalDateTime.parse("2021-09-08T10:30:00"),
        ZoneOffset.ofHours(2))
    ))
  ...
  it should "be defined with '@' and timezone" in {
    eval(""" @"2021-09-08T10:30:00@Europe/Berlin" """) should be (ValDateTime(
      ZonedDateTime.of(
        LocalDateTime.parse("2021-09-08T10:30:00"),
        ZoneId.of("Europe/Berlin")
      )
  ...
  "A years-months duration" should "be defined" in {
    eval(""" duration("P1Y6M") """) should be (ValYearMonthDuration(
      Period.ofYears(1).withMonths(6)
    ))
  }

  it should "be defined with '@'" in {
    eval(""" @"P1Y6M" """) should be (ValYearMonthDuration(
      Period.ofYears(1).withMonths(6)
    ))
  }

  "A days-time duration" should "be defined" in {
    eval(""" duration("P1DT12H30M") """) should be (ValDayTimeDuration(
      Duration.parse("P1DT12H30M")
    ))
  }

  it should "be defined with '@'" in {
    eval(""" @"P1DT12H30M" """) should be (ValDayTimeDuration(
      Duration.parse("P1DT12H30M")
    ))
  }
